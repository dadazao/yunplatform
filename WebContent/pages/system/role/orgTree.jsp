...
ns.role.loadTree = function() {
	var setting = {
			view: {
				fontCss: ns.role.getFontCss,
				showTitle: false
			},
			data : {
				simpleData : {
			...
			callback: {
				onClick: ns.role.onClickCallback
			}
		};
...
ns.role.onClickCallback = function(event, treeId, treeNode){
...
ns.role.getFontCss = function(treeId, treeNode) {
