...
$(function(){
	...
	formbzUrl = "<%=basePath %>/pages/resource/formshowFormHelp.action";
...
function getCode(){
	var urlString = "<%=basePath %>/pages/resource/formgetCode.action";
		$.ajax({
			type:'post',
		...
		<div class="tabsContent">
			<div align="center">
				<form onkeydown="return enterNotSubmit(event);" id="buttonFormID"
					method="post"
					action="<%=basePath%>/pages/resource/formsave.action"
