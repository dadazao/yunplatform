...
<!--
	//function eventXG() {
	//	var urlString = "<%=basePath %>/pages/resource/formedit.action?id="+$("#formId").val() + "&op=edit&formManageId=${formManageId}";
	...
	$(function(){
		...
		loadFormColumn("view");
		//loadFormColumnList();
		xgUrl="<%=basePath %>/pages/resource/formedit.action?id="+$("#formId").val() + "&op=edit&formManageId=${formManageId}";
...
<form id="buttonFormID" method="post" action="<%=basePath %>/pages/resource/formsave.action" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone);">
