...
public class ${mainTable.variables.class}Action extends BaseAction {
	...
	public String save() throws Exception {
		try {
			${mainTable.variables.class?uncap_first}.set${mainTable.parentClassName}(${mainTable.parentClassName?uncap_first}Service.find${mainTable.parentClassName}ById(${mainTable.parentClassName?uncap_first}Id));
