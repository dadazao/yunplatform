...
<div id="${mainTable.variables.class?uncap_first}SubEditDiv">
	<form id="${mainTable.variables.class?uncap_first}SubEditForm" method="post" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogRefresh);" novalidate="novalidate">
