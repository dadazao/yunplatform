...
<script type="text/javascript">
	...
	//加载子列表
	ns.${mainTable.parentClassName?uncap_first}.loadSubList = function(){
	...
	//加载编辑区
	ns.${mainTable.parentClassName?uncap_first}.loadSubEdit = function(domainId){
		if(domainId){
	...
	$(function(){
		ns.${mainTable.parentClassName?uncap_first}.loadSubEdit();
		ns.${mainTable.parentClassName?uncap_first}.loadSubList();
