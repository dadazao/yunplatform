...
@Results(value = { 
	@Result(name = "list", location = "/pages/business/peach/peachList.jsp"),
	@Result(name = "add", location = "/pages/business/peach/peachEdit.jsp"),
	@Result(name = "edit", location = "/pages/business/peach/peachEdit.jsp"),
	@Result(name = "view", location = "/pages/business/peach/peachView.jsp")
})
