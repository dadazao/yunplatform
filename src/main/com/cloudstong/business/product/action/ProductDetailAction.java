...
@Results(value = { @Result(name = "edit", location = "/pages/business/product/productDetailEdit.jsp"),
		@Result(name = "view", location = "/pages/business/product/productDetailView.jsp") })
