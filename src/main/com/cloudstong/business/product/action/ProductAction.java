...
@Results(value = { 
	@Result(name = "list", location = "/pages/business/product/productList.jsp"),
	@Result(name = "add", location = "/pages/business/product/productEdit.jsp"),
	@Result(name = "edit", location = "/pages/business/product/productEdit.jsp"),
	@Result(name = "view", location = "/pages/business/product/productView.jsp")
})
