...
@Results(value = { 
	@Result(name = "list", location = "/pages/business/employee/employeeList.jsp"),
	@Result(name = "add", location = "/pages/business/employee/employeeEdit.jsp"),
	@Result(name = "edit", location = "/pages/business/employee/employeeEdit.jsp"),
	@Result(name = "view", location = "/pages/business/employee/employeeView.jsp")
})
