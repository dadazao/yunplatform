...
@Results(value = { 
		@Result(name = "dialogUserList", location = "/pages/system/user/dialogUserList.jsp"),
		@Result(name = "pUserList", location = "/pages/system/position/addUserList.jsp"),
		@Result(name = "userList", location = "/pages/system/user/userList.jsp"),
		@Result(name = "selectedOrgList", location = "/pages/system/user/selectedOrgList.jsp"),
		@Result(name = "selectedPositionList", location = "/pages/system/user/selectedPositionList.jsp"),
		@Result(name = "selectedRoleList", location = "/pages/system/user/selectedRoleList.jsp"),
		@Result(name = "add", location = "/pages/system/user/userEdit.jsp"),
		@Result(name = "view", location = "/pages/system/user/userView.jsp"),
		@Result(name = "edit", location = "/pages/system/user/userEdit.jsp"),
		@Result(name = "resetPassword", location = "/pages/system/user/resetPassword.jsp"),
		@Result(name = "resetStatus", location = "/pages/system/user/resetStatus.jsp"),
		@Result(name = "dialog", location = "/pages/system/user/sysUserDialog.jsp")
})
