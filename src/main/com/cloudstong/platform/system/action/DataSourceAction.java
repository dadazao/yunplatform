...
@Results(value = { 
	@Result(name = "list", location = "/pages/system/dataSource/datasourceList.jsp"),
	@Result(name = "add", location = "/pages/system/dataSource/datasourceEdit.jsp"),
	@Result(name = "edit", location = "/pages/system/dataSource/datasourceEdit.jsp"),
	@Result(name = "view", location = "/pages/system/dataSource/datasourceView.jsp")
})
