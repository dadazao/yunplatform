...
@Results(value = { @Result(name = "list", location = "/pages/system/authorization/authCustomerList.jsp"),
		@Result(name = "add", location = "/pages/system/authorization/authCustomerEdit.jsp"), 
		@Result(name = "edit", location = "/pages/system/authorization/authCustomerEdit.jsp"),
		@Result(name = "view", location = "/pages/system/authorization/authCustomerView.jsp") })
