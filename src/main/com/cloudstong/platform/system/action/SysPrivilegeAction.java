...
@Results(value = { 
		@Result(name = "privilegeList", location = "/pages/system/privilege/privilegeList.jsp"),
		@Result(name = "add", location = "/pages/system/privilege/privilegeEdit.jsp"),
		@Result(name = "view", location = "/pages/system/privilege/privilegeView.jsp"),
		@Result(name = "edit", location = "/pages/system/privilege/privilegeEdit.jsp"),
		@Result(name = "addResource", location = "/pages/system/privilege/resourceEdit.jsp"),
		@Result(name = "editResource", location = "/pages/system/privilege/resourceEdit.jsp"),
		@Result(name = "resourceList", location = "/pages/system/privilege/resourceList.jsp")
})
