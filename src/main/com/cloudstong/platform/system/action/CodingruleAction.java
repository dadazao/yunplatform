...
@Results(value = { 
	@Result(name = "list", location = "/pages/system/codingrule/codingruleList.jsp"),
	@Result(name = "add", location = "/pages/system/codingrule/codingruleEdit.jsp"),
	@Result(name = "edit", location = "/pages/system/codingrule/codingruleEdit.jsp"),
	@Result(name = "view", location = "/pages/system/codingrule/codingruleView.jsp")
})
