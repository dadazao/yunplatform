...
@Results(value = { 
		@Result(name = "orgList", location = "/pages/system/org/orgList.jsp"),
		@Result(name = "add", location = "/pages/system/org/orgEdit.jsp"),
		@Result(name = "view", location = "/pages/system/org/orgView.jsp"),
		@Result(name = "edit", location = "/pages/system/org/orgEdit.jsp"),
		@Result(name = "userList", location = "/pages/system/org/userList.jsp"),
		@Result(name = "setUserList", location = "/pages/system/org/setuserList.jsp")
})
