...
public class BaseMyBatisDaoImpl<T, PK extends Serializable> extends DaoSupport implements BaseMyBatisDao<T, PK> {
	...
	public List<T> getList(String statementName, Object params, QueryCriteria queryCriteria) {
		...
		return this.sqlSessionTemplate
				.selectList(statementName, filters, new RowBounds(queryCriteria.getCurrentIndex(), queryCriteria.getPageSize()));
	}
	...
	public int getCount() {
		...
		return jdbcTemplate.queryForInt(ibatisSql.getCountSql(), ibatisSql.getParameters());
	}
	...
	public IbatisSql getIbatisSql(String id, Object params) {
		...
		if (parameterMappings != null) {
			...
			MetaObject metaObject = params == null ? null : MetaObject.forObject(params, new DefaultObjectFactory(),
