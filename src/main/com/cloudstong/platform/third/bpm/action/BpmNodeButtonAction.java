...
@Results(value = { @Result(name = "list", location = "/pages/third/bpm/bpmNodeButtonList.jsp"),
		@Result(name = "getByNode", location = "/pages/third/bpm/bpmNodeButtonGetByNode.jsp")
})
