...
@Results({ @Result(name = "view", location = "/pages/message/receivedMessageView.jsp"),
		@Result(name = "replyui", location = "/pages/message/replyMessage.jsp"),
		@Result(name = "list", location = "/pages/message/receivedMessageList.jsp") })
