...
@Results(value = { @Result(name = "portal", location = "/pages/resource/portal/portal.jsp"),
		@Result(name = "newportal", location = "/pages/resource/portal/newportal.jsp"),
		@Result(name = "portlets", location = "/pages/resource/portal/portlets.jsp") })
