...
@Results({ @Result(name = "create", location = "/WEB-INF/view/message/sentMessageEdit.jsp"),
		@Result(name = "list", location = "/WEB-INF/view/message/sentMessageList.jsp"),
		@Result(name = "view", location = "/WEB-INF/view/message/sentMessageView.jsp") })
