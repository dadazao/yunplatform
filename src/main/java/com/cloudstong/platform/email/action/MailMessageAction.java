...
@Results({ @Result(name = "create", location = "/WEB-INF/view/email/mailMessageEdit.jsp"),
		@Result(name = "edit", location = "/WEB-INF/view/email/mailMessageEdit.jsp"), @Result(name = "view", location = "/WEB-INF/view/email/mailMessageView.jsp"),
		@Result(name = "outbox", location = "/WEB-INF/view/email/outbox.jsp"), @Result(name = "draftbox", location = "/WEB-INF/view/email/draftbox.jsp") })
