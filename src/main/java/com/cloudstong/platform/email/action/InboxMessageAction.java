...
@Results({ @Result(name = "inbox", location = "/WEB-INF/view/email/inbox.jsp"), @Result(name = "refetchInbox", location = "inbox", type = "chain"),
		@Result(name = "view", location = "/WEB-INF/view/email/inboxMessageView.jsp"),
		@Result(name = "reply", location = "/WEB-INF/view/email/mailMessageEdit.jsp") })
