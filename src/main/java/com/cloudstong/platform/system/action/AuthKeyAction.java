...
@Results(value = { @Result(name = "list", location = "/WEB-INF/view/system/authorization/authKeyList.jsp"),
		@Result(name = "add", location = "/WEB-INF/view/system/authorization/authKeyEdit.jsp"), 
		@Result(name = "edit", location = "/WEB-INF/view/system/authorization/authKeyEdit.jsp"),
		@Result(name = "view", location = "/WEB-INF/view/system/authorization/authKeyView.jsp") })
