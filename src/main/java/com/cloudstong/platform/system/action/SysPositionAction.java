...
@Results(value = { 
		@Result(name = "positionList", location = "/WEB-INF/view/system/position/positionList.jsp"),
		@Result(name = "add", location = "/WEB-INF/view/system/position/form/positionEdit.jsp"),
