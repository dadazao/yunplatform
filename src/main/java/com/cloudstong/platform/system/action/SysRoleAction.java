...
@Results(value = { 
		@Result(name = "dialogRoleList", location = "/WEB-INF/view/system/role/dialogRoleList.jsp"),
		@Result(name = "roleList", location = "/WEB-INF/view/system/role/roleList.jsp"),
		@Result(name = "add", location = "/WEB-INF/view/system/role/roleEdit.jsp"),
		@Result(name = "view", location = "/WEB-INF/view/system/role/roleView.jsp"),
		@Result(name = "copy", location = "/WEB-INF/view/system/role/roleCopy.jsp"),
