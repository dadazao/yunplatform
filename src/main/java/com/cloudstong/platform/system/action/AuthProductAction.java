...
@Results(value = { @Result(name = "list", location = "/WEB-INF/view/system/authorization/authProductList.jsp"),
		@Result(name = "add", location = "/WEB-INF/view/system/authorization/authProductEdit.jsp"), 
		@Result(name = "edit", location = "/WEB-INF/view/system/authorization/authProductEdit.jsp"),
		@Result(name = "view", location = "/WEB-INF/view/system/authorization/authProductView.jsp") })
