...
@Results(value = { @Result(name = "list", location = "/WEB-INF/view/system/authorization/authCustomerHadwareList.jsp"),
		@Result(name = "edit", location = "/WEB-INF/view/system/authorization/authCustomerHadwareEdit.jsp"),
		@Result(name = "tab", location = "/WEB-INF/view/system/authorization/authCustomerHadwareTab.jsp")})
