...
@Results(value = { @Result(name = "list", location = "/WEB-INF/view/system/authorization/authTemplateList.jsp"),
		@Result(name = "add", location = "/WEB-INF/view/system/authorization/authTemplateEdit.jsp"), 
		@Result(name = "edit", location = "/WEB-INF/view/system/authorization/authTemplateEdit.jsp"),
		@Result(name = "view", location = "/WEB-INF/view/system/authorization/authTemplateView.jsp") })
