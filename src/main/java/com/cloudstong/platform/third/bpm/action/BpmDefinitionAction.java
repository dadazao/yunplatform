...
@Results(value = { @Result(name = "list", location = "/WEB-INF/view/third/bpm/bpmDefinitionList.jsp"),
		@Result(name = "design", location = "/WEB-INF/view/third/bpm/bpmDefinitionDesign.jsp"),
		@Result(name = "detail", location = "/WEB-INF/view/third/bpm/bpmDefinitionDetail.jsp"),
		@Result(name = "nodeSet", location = "/WEB-INF/view/third/bpm/bpmDefinitionNodeSet.jsp"),
		@Result(name = "nodeSummary", location = "/WEB-INF/view/third/bpm/bpmDefinitionNodeSummary.jsp"),
		@Result(name = "userSet", location = "/WEB-INF/view/third/bpm/bpmDefinitionUserSet.jsp"),
		@Result(name = "conditionEdit", location = "/WEB-INF/view/third/bpm/bpmDefinitionConditionEdit.jsp"),
		@Result(name = "instance", location = "/WEB-INF/view/third/bpm/bpmDefinitionInstance.jsp"),
		@Result(name = "versions", location = "/WEB-INF/view/third/bpm/bpmDefinitionVersions.jsp"),
		@Result(name = "otherParam", location = "/WEB-INF/view/third/bpm/bpmDefinitionOtherParam.jsp"),
		@Result(name = "informType", location = "/WEB-INF/view/third/bpm/bpmDefinitionInformType.jsp"),
		@Result(name = "flowImg", location = "/WEB-INF/view/third/bpm/bpmDefinitionFlowImg.jsp"),
		@Result(name = "taskNodes", location = "/WEB-INF/view/third/bpm/bpmDefinitionTaskNodes.jsp") })
