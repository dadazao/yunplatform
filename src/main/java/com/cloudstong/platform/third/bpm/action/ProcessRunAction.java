...
@Results(value = { 
		@Result(name = "list", location = "/WEB-INF/view/third/bpm/processRunList.jsp"),
		@Result(name = "view", location = "/WEB-INF/view/third/bpm/processRunView.jsp"),
		@Result(name = "history", location = "/WEB-INF/view/third/bpm/processRunHistory.jsp")
})
