...
@Namespace("/pages/resource/fbutton")
@Results(value = { 
		@Result(name="addButton", location = "/WEB-INF/view/resource/form/formButtonEdit.jsp"),
		@Result(name="editButton", location = "/WEB-INF/view/resource/form/formButtonEdit.jsp"),
		@Result(name="listButton", location = "/WEB-INF/view/resource/form/formButtonList.jsp")
})
