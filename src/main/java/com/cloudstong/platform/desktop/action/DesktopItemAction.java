...
@Results({ @Result(name = "preview", location = "/WEB-INF/view/desktop/desktopItemPreview.jsp"), @Result(name = "view", location = "/WEB-INF/view/desktop/desktopItemView.jsp"), @Result(name = "list", location = "/WEB-INF/view/desktop/desktopItemList.jsp"), @Result(name = "edit", location = "/WEB-INF/view/desktop/desktopItemEdit.jsp") })
