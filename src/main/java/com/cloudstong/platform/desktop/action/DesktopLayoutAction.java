...
@Results({ @Result(name = "list", location = "/WEB-INF/view/desktop/desktopLayoutList.jsp"),
		@Result(name = "edit", location = "/WEB-INF/view/desktop/desktopLayoutEdit.jsp"),
		@Result(name = "relayout", location = "/WEB-INF/view/desktop/previewArea.jsp"),
		@Result(name = "design", location = "/WEB-INF/view/desktop/desktopLayoutDesign.jsp"),
		@Result(name = "add", location = "/WEB-INF/view/desktop/desktopLayoutEdit.jsp") })
