...
@Results({ @Result(name = "design", location = "/WEB-INF/view/desktop/desktopDesign.jsp"),
		@Result(name = "desktop", location = "/WEB-INF/view/desktop/desktop.jsp"),
		@Result(name = "showDesigned", location = "/WEB-INF/view/desktop/previewArea.jsp") })
