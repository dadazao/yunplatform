...
<!--
	...
	function showComBox() {
		var urlString = "<%=basePath %>/pages/resource/formshowComBox.action?comBoxId=" + $("#comBoxValueId").val();
		$.ajax({
			type:'post',
			url: urlString,
	...
	function showTextField() {
		$("#textFieldLabel").show();
		var urlString = "<%=basePath %>/pages/resource/formshowTextField.action?textFieldId=" + $("#textFieldValueId").val();
		$.ajax({
			type:'post',
			url: urlString,
			success: function(data){
	...
	function showDate() {
		var urlString = "<%=basePath %>/pages/resource/formshowDate.action?dateId=" + $("#dateId").val();
		$.ajax({
			type:'post',
			url: urlString,
			success: function(data){
	...
	function showRadio() {
		var urlString = "<%=basePath %>/pages/resource/formshowRadio.action?radioId=" + $("#radioId").val();
		$.ajax({
			type:'post',
			url: urlString,
			success: function(data){
	...
	function showCheckBox() {
		var urlString = "<%=basePath %>/pages/resource/formshowCheckBox.action?checkBoxId=" + $("#checkBoxId").val();
		$.ajax({
			type:'post',
			url: urlString,
			success: function(data){
	...
	function showSearchComBox() {
		var urlString = "<%=basePath %>/pages/resource/formshowSearchComBox.action?searchComBoxId=" + $("#searchComBoxId").val();
		$.ajax({
			type:'post',
			url: urlString,
			success: function(data){
	...
	function showTree(){
		var urlString = "<%=basePath %>/pages/resource/formshowTree.action?treeId=" + $("#treeId").val();
		$.ajax({
			type:'post',
			url: urlString,
			success: function(data){
	...
	function showEditor() {
		var urlString = "<%=basePath %>/pages/resource/formshowEditor.action?editorId=" + $("#editorId").val();
		$.ajax({
			type:'post',
			url: urlString,
			success: function(data){
	...
	function showRelationTable() {
		var urlString = "<%=basePath %>/pages/resource/formshowRelationTable.action?table=" + $("#relationTableId").val();
		$.ajax({
			type:'post',
			url: urlString,
			success: function(data){
	...
	function showRelationColumn() {
		var urlString = "<%=basePath %>/pages/resource/formshowRelationColumn.action?table=" + $("#relationTableSelectId option:selected").val() + "&column=" + $("#relationColumnId").val();
		$.ajax({
			type:'post',
			url: urlString,
			success: function(data){
	...
	function showFormColumnTab(){
		var urlString = "<%=basePath %>/pages/resource/formshowFormColumnTab.action?formId="+$("#formId").val()+"&formColumnTabId="+$("#formColumnTabId").val();
			$.ajax({
				async: false,
				type:'post',
				url: urlString,
	...
	function showFormColumnPartition(tabId){
		...
		var urlString = "<%=basePath %>/pages/resource/formshowFormColumnPartition.action?formColumnTabId="+tabId+"&formColumnPartitionId="+$("#formColumnPartitionId").val();
		$.ajax({
			async: false,
			type:'post',
			url: urlString,
		...
		$.ajax({
			async: false,
			type:'post',
			url: "<%=basePath %>/pages/resource/formcheckTabType.action?tabId="+tabId,
			success: function(data){
				var tabType = data;
				if(tabType == "1"){
					$.ajax({
						async: false,
						type:'post',
						url: "<%=basePath %>/pages/resource/formshowAllTable.action?formId="+$("#formId").val()+"&tabId="+tabId,
						success: function(data){
							$("#reltblDiv").html(data);
						}
					});
					...
					$.ajax({
						async: false,
						type:'post',
						url: "<%=basePath %>/pages/resource/formshowRelTable.action?formId="+$("#formId").val()+"&tabId="+tabId,
						success: function(data){
							$("#reltblDiv").html(data);
						}
					});
	...
	function showFormColumnList(){
		...
		//根据所属表加载关联字段
		var urlString = "<%=basePath %>/pages/resource/formshowRelColumn.action?tableId="+tableid;
		$.ajax({
			async: false,
			type:'post',
			url: urlString,
