...
function showTemplateType(type){
	...
	var urlString = "<%=basePath%>/pages/resource/tabshowTemplateType.action?type=" + type+"&tabtemplateType="+$("#tabtemplateType").val();
		$.ajax({
			type:'post',
			url: urlString,
			success: function(data){
...
function showTemplate(type,templateType){
	var urlString = "<%=basePath%>/pages/resource/tabshowTemplate.action?type=" + type+"&templateType="+templateType+"&tabtemplate="+$("#tabtemplate").val();
	$.ajax({
		type:'post',
		url: urlString,
		success: function(data){
