...
function showButtonTab(){
	var urlString = "<%=basePath%>/pages/resource/fbuttonshowButtonTab.action?formId="+$("#formId").val()+"&buttonTabId="+$("#buttonTabId").val();
		$.ajax({
			type:'post',
			url: urlString,
			async:false,
...
function showButtonPartition(tabId){
	var urlString = "<%=basePath%>/pages/resource/fbuttonshowPartition.action?buttonTabId="+tabId+"&buttonPartitionId="+$("#buttonPartitionId").val();
		$.ajax({
			type:'post',
			url: urlString,
			async:false,
