	...
	<tr id="textBoxId">
		...
		<td align="left" colspan="3">
			<select name="formColumn.compexId" style="width: 175px">
				<c:forEach items="${codeCaseCades}" var="codeCaseCade">
					<option value="${codeCaseCade.id}"
						<c:if test="${formColumn.compexId==codeCaseCade.id }">selected="selected"</c:if>>
						${codeCaseCade.codeCaseCadeName}
					</option>
				</c:forEach>
			</select>
		</td>
