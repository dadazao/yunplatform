...
<script type="text/javascript">	
	function loadButton() {
		var urlString = "<%=basePath %>/pages/resource/fbutton/addButton.action?formId="+$("#formId").val();
		$('#buttonId').load(urlString);
	}
	function loadButtonList() {
		var urlString = "<%=basePath %>/pages/resource/fbutton/listButton.action?formId=" + $("#formId").val();
	...
	function loadEditFormButton(id) {
		var urlString = "<%=basePath %>/pages/resource/fbutton/edit.action?formId="+$("#formId").val()+"&buttonId=" + id;
		$('#buttonId').load(urlString);	
	}
	...
	function deleteFormButton() {
		var urlString = "<%=basePath %>/pages/resource/fbutton/delete.action";
		$.ajax({
			type:'post',
			url: urlString,
	...
	function loadTab() {
		var urlString = "<%=basePath %>/pages/resource/tab/add.action";
		$('#tabId').loadUrl(urlString);
	}
	function loadTabList() {
		var urlString = "<%=basePath %>/pages/resource/tab/list.action?formId=" + $("#formId").val();
		$.ajaxSetup({async: false});
	...
	function loadEditTab(id) {
		var urlString = "<%=basePath %>/pages/resource/tab/edit.action?id=" + id;
	...
	function deleteTab() {
		var urlString = "<%=basePath %>/pages/resource/tab/delete.action";
		$.ajax({
			type:'post',
			url: urlString,
	...
	function loadFormColumn() {
		var urlString = "<%=basePath %>/pages/resource/form/addColumn.action?formId=" + $("#formId").val();
	...
	function loadFormColumnList(tabid,partitionid) {
		...
		var urlString = "<%=basePath %>/pages/resource/form/listColumn.action?formId=" + $("#formId").val()+"&tabId="+tabid+"&partitionId="+partitionid;
		$.ajaxSetup({async: false});
	...
	function deleteFormColumn() {
		var urlString = "<%=basePath %>/pages/resource/form/deleteColumn.action";
		$.ajax({
			type:'post',
			url: urlString,
...
<body>
	...
	<div class="pageHeader">
		<div class="searchBar">
			<form onsubmit="return navTabSearch(this);" action="<%=basePath %>/pages/resource/form/list.action" method="post">
				<input type="hidden" name="code" value="${code}">
...
<%--						</td>--%>
						...
						<td align="center">
							&nbsp;
							<a target="dialog" rel="formDialog" mask="true" width="950" height="650" href="<%=basePath %>/pages/resource/form/view.action?id=${form.id}&formManageId=${formManageId}" target="navTab"><span>维护</span></a>
							&nbsp;
						</td>
	                </tr>
	            </c:forEach>
