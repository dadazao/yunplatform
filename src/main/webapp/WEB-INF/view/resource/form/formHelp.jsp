...
表单【新建】界面是对【<font color="blue">表单表单</font>】单条信息进行录入操作的区域；点击列表界面的【新建】按钮，即可弹出表单【新建】界面；分为按钮区、信息操作区。<br/><br/>
...
•【<font color="blue">打印</font>】按钮：【<font color="blue">表单打印</font>】；<br/>
•【<font color="blue">帮助</font>】按钮：【<font color="blue">显示该表单的帮助信息</font>】；
<br/>
2、信息操作区<br/>
【<font color="blue">表单表单</font>】表单【新建】界面信息操作区共包括【<font color="blue">4</font>】个选项卡<br/>
2.1、【<font color="blue">基本信息</font>】选项卡<br/>
2.2、【<font color="blue">选项卡信息</font>】选项卡<br/>
2.3、【<font color="blue">按钮信息</font>】选项卡<br/>
2.4、【<font color="blue">字段信息</font>】选项卡<br/>
<br/><br/>
<p>备注：创建人/创建时间/修改人/修改时间四项信息由系统统一生成，用户尽可查看不能新建和修改。</p>
<br/><br/>
3.  表单【维护】界面是对【<font color="blue">表单表单</font>】单条信息进行查看和修改的区域；点击列表界面最右侧【操作】列的【维护】按钮，即可弹出表单【维护】界面
</p>
</div>
</div>