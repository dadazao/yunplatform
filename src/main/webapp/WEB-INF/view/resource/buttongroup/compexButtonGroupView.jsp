...
<!--
	$(function(){
		...
		var urlString = "<%=basePath %>/pages/resource/buttonGroupviewJson.action?params=${params}&formId=${formId}";
		//生成查看页面
		compexViewJson(urlString);
		//删除ACTION URL
		scUrl = "<%=basePath %>/pages/resource/buttonGroupsingleDelete.action?params=${params}";
		//修改ACTION URL
		xgUrl = "<%=basePath %>/pages/resource/buttonGroupedit.action?formId=${formId}&params=${params}" + "&op=edit";
