...
<script type="text/javascript">	
	$(function(){
		...
		bcUrl = "<%=basePath%>/pages/resource/compexsave.action";
...
<body>
	<form id="pagerForm" method="post" action="<%=basePath %>${listurl}">
											...
											<c:if test="${ce.formColumn.defaultValue == '%username%'}">
												...
												<script>
													$.ajax({
														type:'post',
														dataType: 'json',
														url: "<%=basePath %>/pages/resource/compexshowUserName.action?userid=${ce.value}",
														async:false,
											...
											<c:if test="${ce.formColumn.defaultValue == '%orgname%'}">
												...
												<script>
													$.ajax({
														type:'post',
														dataType: 'json',
														url: "<%=basePath %>/pages/resource/compexshowOrgName.action?orgid=${ce.value}",
														async:false,
														success: function(data){
															var org = data;
															value = org.tblName;
