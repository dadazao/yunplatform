...
<div id="userTabList">
<form id="pagerForm" method="post" action="<%=basePath %>/pages/system/org/orguserList.action?forward=setUserList">
    ...
    <table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0" align="center" class="tableClass" style=" border-left:1px #ededed solid;">
		...
		<thead>
			<tr>
				...
				<th class="thClass" width="20%">操作</th>
			</tr>
		</thead>
...
<div class="buttonPanel">
	<p align="center">
		<button type="button" class="listbutton" onclick="ns.org.setAddUser()">添加</button>
