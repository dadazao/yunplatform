...
<!--
ns.position.setAddUser = function(){
	$.pdialog.open("<%=basePath %>/pages/system/position/addUser.action?positionId=${positionId}&forward=setUserList","addUserDialog","添加用户",{width:800,height:500,mask:true,resizable:true});
}
//-->
</script>
<div id="userTabList">
<form id="pagerForm" method="post" action="<%=basePath %>/pages/system/position/positionuserList.action?forward=setUserList">
...
<div class="buttonPanel">
	<p align="center">
		<button type="button" class="listbutton" onclick="ns.position.setAddUser()">添加</button>
