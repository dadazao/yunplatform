...
<div class="panel">
	<div class="panel-top">
		...
		<div class="panel-toolbar">
			<div class="toolBar">
				<div class="group"><a class="link agree" id="agree" href="#" onclick="save(true)"><span></span>同意</a></div>
				<div class="l-bar-separator"></div>
				<div class="group"><a class="link notAgree" id="notAgree" href="#" onclick="save(false)"><span></span>反对</a></div>
				<div class="l-bar-separator"></div>
